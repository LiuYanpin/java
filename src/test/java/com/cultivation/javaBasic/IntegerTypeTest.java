...
class IntegerTypeTest {
    ...
    void should_get_range_of_primitive_int_type() {
        ...
        // <!--start
        final int maximumSymbol = 2147483647;//Integer.MAX_VALUE
        final int minimumSymbol = -2147483648;//Integer.MIN_VALUE
        // --end-->
    ...
    void should_equal(){
        //float re2 = 1/2.0;
        assertEquals(1/2.00, 1/2.0);
    }


    @Test
    void should_truncate_number_when_casting() {
        final int integer = 0x0123_4567;//方便阅读
